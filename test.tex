...
\let\hbox\__sdaps_textbox_hbox:nn
...
\ExplSyntaxOff
\hbox {3bp} { This hbox } should have the same baseline as on the outside and
the other \hbox {3bp} { hbox } which should be on the left edge due to the justified layout.
\hbox {3bp} { Another box }  \hbox {3bp} { fun!}.
And in a formula $ f(x) = \frac{1}{c\,\hbox{3bp}{box}} \hstretch{2mm}{5mm}{70mm}{1} $
\ExplSyntaxOn
...
\let \vbox \__sdaps_textbox_vbox:nnn

\ExplSyntaxOff
\noindent asdf \vbox {0.8\linewidth} {3bp} {
