...
\singlemarkother{Hallo}{lower}{upper}{alt}
    ...
    \begin{choicequestion}[cols=3,var=q,text=tq]{Same thing again, with variables and text.}
      \choiceitem[var=a1,text=ta1]{SDAPS}
      \choicemulticolitem[var=a2,text=ta2]{2}{Auto Multiple Choice}
      \choiceitem[var=a3,text=ta3]{QueXF}

      % Insert a text field. The freeform box automatically scales horizontally
      % The first parameter is the height of the box. The second parameter
      % is the amount of columns it should span.
      \choiceitemtext[var=a4,text=ta4]{1.2cm}{2}{Other:}
      \choicemulticolitem[var=a1,text=ta1]{2}{Auto Multiple Choice}
    \end{choicequestion}
